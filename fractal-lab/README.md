...
**React (Vite) + TypeScript** frontend and a **FastAPI** backend that renders the **Mandelbrot set**, **Julia sets**, and a **fractal tree** (NumPy + Pillow). Routes: **`/`** (Mandelbrot), **`/julia`**, **`/tree`**.
